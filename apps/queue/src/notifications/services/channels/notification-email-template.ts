    ...
    if (threadTitle) {
        content.push({
            ...
            settings: {
                ...
                lineHeight: "1.5",
                foregroundColor: isConversation ? brand.text : brand.mutedText,
    ...
    if (parentText) {
        ...
        content.push({
            ...
            settings: {
                ...
                fontSize: "13px",
                lineHeight: "1.5",
                foregroundColor: brand.mutedText,
                backgroundColor: brand.softPanel,
                paddingTop: "16px",
                paddingBottom: "4px",
            },
        });
    ...
    content.push(
        {
            ...
            settings: {
                ...
                buttonTextColor: brand.primaryForeground,
    ...
    if (!hideCourseLitBranding) {
        content.push({
            ...
            settings: {
                ...
                alignment: "center",
                fontSize: "12px",
                textColor: brand.mutedText,
                textDecoration: "none",
                buttonBorderColor: brand.border,
                paddingTop: "0px",
                paddingBottom: "40px",
            },
        });
