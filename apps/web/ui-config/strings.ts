...
export const LOGIN_NAV_HOME = "Početna";
export const LOGIN_NAV_COURSES = "Kursevi";
export const LOGIN_NAV_INSTRUCTORS = "Predavači";
export const LOGIN_NAV_FAQ = "FAQ";
export const LOGIN_NAV_MENU_OPEN = "Otvori meni";
export const LOGIN_NAV_MENU_CLOSE = "Zatvori meni";
export const LOGIN_NAV_LOGO_ALT = "Future Fizio Hub";
...
export const LOGIN_FORM_LABEL = "Unesite Vašu mejl adresu da se prijavite";
